const faqList = [
  {
    question: 'What is the purpose of FFCS-inator?',
    answer:
  ...
  {
    question: 'Can I share my timetable with others?',
    answer:
  ...
  {
    question: 'Do I need to log in to use FFCS-inator?',
    answer:
  ...
  {
    question: 'Does this FFCS-inator work for all VIT campuses?',
    answer:
